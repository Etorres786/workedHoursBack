package com.ias.report.infraestructura.error;
...
import com.ias.report.dominio.excepcion.ReportException;
...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        CODIGOS_ESTADO.put(ReportException.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
